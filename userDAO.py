...
#    def add_user(self, username, name, password, email, phone):
        password_hash = self.make_pw_hash(password)

#        user = {'_id': username, 'name': uname, 'password': password_hash, 'phone' : phone}
        user = {'_id': username, 'name': name, 'password': password_hash}
        if email != "":
            user['email'] = email
